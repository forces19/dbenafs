...
<div class="perkembangan">
		<div class="isi">            
            <h3 class="h3per">Psikologi Perkembangan</h3>
            <p class="garis">______________________________</p>
            <p class="garis">________________________________________________</p>
            <p class="pper">Psikologi perkembangan adalah ilmu yang mempelajari pola tingkah laku 
				individu dalam perkembangannya dan latar belakang (background) yang mempengaruhinya. 
				Dalam ruang lingkup psikologi, ilmu ini termasuk dalam psikologi khusus karena 
				psikologi perkembangan mempelajari hal hal khusus dan unik pada tingkah laku individu. 
				Dengan mempelajari psikologi perkembangan, diharapkan mampu memahami diri Anda dan individu 
				pada umumnya dengan lebih baik, sehingga Anda dapat membina dan mengembangkan kearah kehidupan yang 
				lebih positif sesuai dengan yaitu dapat memberikan bantuan pada perkembangan fisik maupun 
				psikis individu seoptimal mungkin, memilih dan menentukan tujuan materi dan strategi belajar 
				sesuai dengan tingkat kemampuan intelektual individu, menghadapi individu dengan benar dalam membentuk 
				perilaku dengan benar serta dapat terhindar dari pemahaman yang salah tentang anak.</p>
		</div>
