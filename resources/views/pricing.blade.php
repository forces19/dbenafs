					...
					<div class="navigation-right">
						...
						<nav class="link-effect-3" id="link-effect-3">
							<ul class="nav1 nav nav-wil">
								...
								<li class="active"><a data-hover="Pricing" href="{{ url('pricing') }}">Pricing</a></li>
								<li class="dropdown">
...
<div class="pricing">
		<div class="container">            
            <h3>JASA PSIKOLOGI PERKEMBANGAN</h3>
            <p class="garis">______________________________</p>
            <p class="garis">________________________________________________</p>
            <p>Psikotes dan tes psikologi untuk sekali tes perindividu dikenakan tarif <strong>150.000</strong><br>Assesment center/ Training/ Psychotherapy(Konseling) 1 sesi <strong>350.000</strong> (45-50menit)</p><br>
            <h4>Pelaksanaan Psikotest</h2>
                    <p>* Dapat dilakukan di Kantor atau di ruang Praktek kami<br>
                        * Daya Tampung  : 10 - 15 individu<br>
                        * Hari          : Senin - Jumat<br>
                        * Jam Buka      : Pk. 08.00 - Pk. 17.00</p>
            <p>* Nb:* Perusahaan/ Sekolah/ Individu diharapkan dapat membuat janji terlebih dahulu  sebelum datang sehingga dapat meminimalisasikan waktu yang bersamaan</p><br><br>
            <h4>Pembayaran</h4>
                    <p>Dapat dilakukan melalui cash di kantor kami
                        <br>-Konfirmasi-<br>
                        Format SMS : <br>
                            *Nama Lengkap<br>
                            * Paket Jasa yang diinginkan <br>
                            * Alamat Pengiriman Hasil Test</p>
		</div>
	</div>
<!-- //pricing -->
<!-- contact -->
